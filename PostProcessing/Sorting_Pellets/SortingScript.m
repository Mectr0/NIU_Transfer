...
maxP = 55; %Max amount of pellets that could fit in a bin (for preallocation) May want to increase for bigger bins
...
%save('../Data_Plotting/PelletData13_0.mat','-v7.3') %Saving data to the Data_Plotting Directory. (version 7.3 for large files)
